...
int main() {
    ...
    {
    case 1:
        printf("SELECIONE A CARTA PARA INSERIR OS DADOS:\n\n");
        printf("----------------------------\n\n");
        printf("1. Carta 1\n");
        printf("2. Carta 2\n");
        ...
        case 3:
        //CÓDIGO DE RETORNAR AO MENU ANTERIOR
        break;
    ...
    case 2:
        printf("SELECIONE O DADO QUE DESEJA COMPARAR:\n\n");
        printf("----------------------------\n\n");
        printf("1. Código\n");
        printf("2. Estado\n");
        printf("3. Cidade\n");
    ...
    case 3:
        ...
        //CÓDIGO DE REPETIR O MENU PRINCIPAL
